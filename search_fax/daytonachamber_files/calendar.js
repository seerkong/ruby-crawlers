	...
	init: function () {
        ...
        for (var i=0; i<x.length; i++) {
            x[i].onfocus = function () {
				...
				popUpCal.selectedMonth = currdate.getMonth();
                popUpCal.selectedYear = currdate.getFullYear();
                popUpCal.selectedDay = currdate.getDate();
